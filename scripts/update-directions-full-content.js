...
async function updateDirectionsFullContent() {
  try {
    ...
    const directionIds = Object.keys(detailedContent);
    console.log(`\n📝 Оновлюю повний контент для ${directionIds.length} напрямків\n`);
    ...
    for (const directionId of directionIds) {
      ...
      const content = detailedContent[directionId];
      
      direction.mainTitleBefore = content.mainTitleBefore;
      direction.mainTitleBeforeEn = content.mainTitleBeforeEn;
      direction.mainTitleHighlight = content.mainTitleHighlight;
      direction.mainTitleHighlightEn = content.mainTitleHighlightEn;
      direction.mainTitleAfter = content.mainTitleAfter;
      direction.mainTitleAfterEn = content.mainTitleAfterEn;
      direction.intro = content.intro;
      direction.introEn = content.introEn;
      direction.sections = content.sections;
      
      await direction.save();
      
      console.log(`✅ ${directionId} — оновлено повністю (title + intro + ${content.sections.length} секцій)`);
      updated++;
    }
